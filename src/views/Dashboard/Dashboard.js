          ...
          <Col>
            <Card>
              <CardBlock className="card-body">
                <Row>
                  <Col sm="5">
                    <CardTitle className="mb-0">Screen Traffic</CardTitle>
              ...
              <CardFooter>
                <ul>
                  ...
                  <li className="d-none d-md-table-cell">
                    <div className="text-muted">Recent</div>
                    <strong>24</strong>
                    <Progress className="progress-xs mt-2" color="info" value="20"/>
                  </li>
                  <li>
                    <div className="text-muted">Approved Views</div>
                    <strong>7706 Views</strong>
                    <Progress className="progress-xs mt-2" color="warning" value="60"/>
                  </li>
                  <li className="d-none d-md-table-cell">
                    <div className="text-muted">New</div>
                    <strong>223 Unique</strong>
                    <Progress className="progress-xs mt-2" color="danger" value="80"/>
                  </li>
                  <li className="d-none d-md-table-cell">
                    <div className="text-muted">Percentage Difference</div>
